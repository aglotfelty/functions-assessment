...
def say_hi(name):
    """Prints 'Hi' followed by the string input"""
...
def print_sign(integer):
    """Prints whether an integer is higher than, lower than or equal to zero"""
...
def total_meal_price(meal_price, tip_percent=.15):
    """Calculates a total amount to pay based on meal price and tip"""
